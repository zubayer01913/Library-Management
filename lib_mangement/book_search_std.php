...
if (isset($_POST['book_name'])) {
  $colname_rsBooks = $_POST['book_name'];
}
mysql_select_db($database_lib_ss, $lib_ss);
$query_rsBooks = sprintf("SELECT ref_number, book_name, book_writers, book_edition, book_isbn, book_avail, ebook_link FROM books WHERE book_name LIKE %s", GetSQLValueString("%" . $colname_rsBooks . "%", "text"));
...
<form id="form1" name="form1" method="post" action="">
    ...
    <input type="text" class="form-control" id="exampleInputEmail1" name="book_name" placeholder="Book Name">  
  </div>
...
<center>
    <a href="student_index.php" class="btn btn-primary" role="button">Back to Home</a>
    </center>
